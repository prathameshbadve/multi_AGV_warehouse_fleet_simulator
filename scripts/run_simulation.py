...
def main():
    ...
    parser.add_argument("--config", type=str, default="config/default_warehouse.yaml",
                        help="Path to warehouse config YAML")
    parser.add_argument("--n-agvs", type=int, default=50,
                        help="Number of AGVs to deploy")
    parser.add_argument("--hours", type=float, default=None,
                        help="Simulation duration in hours (overrides config)")
    parser.add_argument("--seed", type=int, default=None,
                        help="Random seed (overrides config)")
    parser.add_argument("--strategy", type=str, default="cpsat",
                        choices=["cpsat", "greedy"],
                        help="Assignment strategy: cpsat (default) or greedy")
